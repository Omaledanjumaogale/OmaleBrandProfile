<footer class="px-6 lg:px-12 py-8 border-t border-border flex items-center justify-between flex-wrap gap-4 bg-bg">
	<div class="font-['Bebas_Neue'] text-[18px] tracking-[2px] text-text">
