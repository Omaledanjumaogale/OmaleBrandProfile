...
declare module '$env/static/private' {
	...
	export const CONVEX_DEPLOY_KEY: string;
	export const CONVEX_HTTP_ACTIONS_URL: string;
	export const ADMIN_SESSION_SECRET: string;
...
declare module '$env/static/public' {
	...
	export const PUBLIC_SUPER_ADMIN_EMAIL: string;
	export const PUBLIC_SUPER_ADMIN_PASSWORD: string;
}
...
declare module '$env/dynamic/public' {
	export const env: {
		...
		PUBLIC_SUPER_ADMIN_EMAIL: string;
		PUBLIC_SUPER_ADMIN_PASSWORD: string;
